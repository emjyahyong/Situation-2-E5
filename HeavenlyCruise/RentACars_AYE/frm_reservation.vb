...
Public Class frm_reservation
    ...
    Private Sub btn_reserver_Click(sender As Object, e As EventArgs) Handles btn_reserver.Click
        ...
        Catch ex As Exception
            ' Gérer l'exception en affichant un message d'erreur à l'utilisateur
            MsgBox("Une erreur est survenue lors de l'ajout de la réservation : " & ex.Message, MsgBoxStyle.Critical, "Erreur")
        End Try
    End Sub
